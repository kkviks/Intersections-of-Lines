...
/// </summary>
/// <param name="p1">1st endpoint of the 1st line segment.</param>
/// <param name="q1">2nd endpoint of the 1st line segment.</param>
/// <param name="p2">1st endpoint of the 2nd line segment.</param>
...
Point intersection(Point A, Point B, Point C, Point D)
{
	...
	double determinant = a1 * b2 - a2 * b1; // determinant for a 2 dimensional matrix by Cramer's rule is calculated here
